<div class="container pt-4">
    <div class="info-box bg-transparent shadow-none">
        <?php
        $logo_app = $setting->logo_kanan == null ? base_url() . 'assets/img/logopertiwi.png' : base_url() . $setting->logo_kanan;
        ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('form#login').on('submit', function(e){
            ...
            localStorage.setItem('pertiwiCBT.login', cbtOnly !== undefined ? '1' : '0')
            ...
            success: function(data){
                ...
                if(data.status){
                    ...
                    const isLogin = localStorage.getItem('pertiwiCBT.login')
