...
<head>
    ...
    <title>Pertiwi CBT</title>

    <?php $logo_app = $setting->logo_kiri == null ? base_url() . 'assets/img/logopertiwi.png' : base_url() . $setting->logo_kiri; ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-6">
                ...
                <span class="text-lg"><b>PertiwiCBT</b></span>
            </div>
